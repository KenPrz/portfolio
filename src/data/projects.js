export const projects = [
    {
        ...
        category: 'Web App',
        color: '#0ea5e9',
        description: 'A centralized procurement workflow platform designed to digitalize and standardize the full lifecycle of Purchase Requisitions (PR), Purchase Orders (PO), and Receiving Reports (RR).',
        technologies: ['Vue.js', 'Laravel', 'MySQL', 'Tailwind CSS', 'Workflow'],
        link: '#',
        linkIcon: 'github',
        pathTitle: 'Internal System',
        images: [
            { itemImageSrc: '/images/nexus/nexus-1.png', alt: 'Nexus Procurement Dashboard' },
            { itemImageSrc: '/images/nexus/nexus-2.png', alt: 'Nexus Procurement Workflow' }
        ],
...
The project challenged me to integrate knowledge from multiple domains including web development, IoT protocols, database management, and UI/UX design, resulting in a polished, production-ready system.`
    },
    {
        ...
        category: 'Web App',
        color: '#a855f7',
        description: 'Youth Card RFID System (YCRS) commissioned by Sangguniang Kabataan Inarado Daraga chapter is a web application designed for managing event attendance and points redemption seamlessly.',
...
Though currently on hold, this project demonstrates my ability to create practical solutions for real-world community needs.`
    },
    {
        ...
        category: 'IoT',
        color: '#f59e0b',
        description: 'Commissioned by Bicol University BUCAF students, the AGMS greenhouse monitoring system utilizes Arduino and a network of sensors to track temperature, humidity, and soil moisture.',
...
Data logging is a crucial component, allowing students and researchers to analyze trends over time and correlate environmental conditions with plant growth and health.`
    },
    {
        ...
        category: 'Web App',
        color: '#9333ea',
        description: 'This system is designed to streamline Bicol University\'s compliance with the Anti-Red Tape Act (ARTA) by monitoring service ratings across offices.',
