...
<template>
    <h1 class="ps-10 pt-10 text-3xl text-center">Projects/Commissions Timeline</h1>
                ...
                <template #content="slotProps">
                    <Card class="mt-3">
                        ...
                        <template #content>
                            ...
                            <div class="pt-4">
                                <a class="text-offset_secondary hover:text-offset transition-colors duration-200" :href="slotProps.item.link">
